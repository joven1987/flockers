...
<html lang="en">
  ...
  <head>
    ...
    <title>Flockers | Events | eSports</title>

    <!-- Bootstrap core CSS -->
    <link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
   <link rel="stylesheet" type="text/css" href="css/eSport.css">
  ...
  <body style=" background-image:url('images/eSports/esports.jpg');  background-repeat: no-repeat; width: 100%;  ">
...
<div class="container">
	<div class="row">
		<div class="titletop">
			...
			<p class="texttop">
			Find out what's happening in eSports Events around <br> Cebu  and start meeting up with the ones near you.
			</p>
			
			 <button type="button" id="create" class="btn signup" data-toggle="modal" data-target="#login">Sign Up!</button>
      ...
      <div class="row" style="padding-top: 4%;">
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="images/eSports/ev1.jpg" alt=""></a>
            <div class="card-body">
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="images/eSports/ev2.jpg" alt=""></a>
            <div class="card-body">
              <h4 class="card-title title">
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="images/eSports/ev3.jpg" alt=""></a>
             <div class="card-body">
              <h4 class="card-title title">
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="images/eSports/ev4.jpg" alt=""></a>
           <div class="card-body">
              <h4 class="card-title title">
